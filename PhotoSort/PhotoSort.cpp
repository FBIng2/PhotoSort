...
// PhotoSort.cpp : définit les comportements de classe de l'application.
//
...
BEGIN_MESSAGE_MAP(CPhotoSortApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Construction de CPhotoSortApp

CPhotoSortApp::CPhotoSortApp()
{
...
// Le seul et unique objet CPhotoSortApp

CPhotoSortApp theApp;


// Initialisation de CPhotoSortApp

BOOL CPhotoSortApp::InitInstance()
{
